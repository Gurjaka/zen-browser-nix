{
  description = "Zen browser's flake! Experience tranquillity while browsing the web without people tracking you!";
  ...
  outputs =
    ...
    let
      ...
      system = "x86_64-linux";
      version = "1.0.2-b.5";
      downloadUrl = "https://github.com/zen-browser/desktop/releases/download/${version}/zen.linux-x86_64.tar.bz2";
